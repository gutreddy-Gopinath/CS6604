...
function App() {
    ...
    let i = [
        {
            label: 'a1', start: 0, end: 11, data: [
                {
                    label: 'b1', start: 0, end: 5, data: [
                        {
        ...
        {
            label: 'a2', start: 12, end: 23, data: [
                {
                    label: 'b3', start: 12, end: 17, data: [
                        {
    ...
    return (
        <div className="App">
            <div className="App-div" style={{ margin: '15px', padding: '15px', display: 'flex' }}>
                ...
                <div style={{ width: '70%', height: '50em' }}>
                    <Tree
                        data={dataIndex}
